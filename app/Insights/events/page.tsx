        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {featuredEvents.map((event) => (
                  <div key={event.id} className={`group rounded-2xl overflow-hidden border transition-all duration-300 ${
                    isDark
                    ...
                    <div className="relative h-64 overflow-hidden">
                      ...
                      <div className="absolute top-4 right-4">
                        <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                          isDark ? 'bg-white/20 text-white border-white/30' : 'bg-gray-100 text-gray-700 border-gray-200'
                        }`}>
                          {event.format}
                        </span>
                      </div>
          ...
          {filteredEvents.length > 0 && (
            <div className="text-center mt-12">
              <button className={`px-8 py-3 rounded-xl font-medium transition-colors ${
                isDark
