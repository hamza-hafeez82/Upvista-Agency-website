...
const careersTranslations: { [key: string]: { [key: string]: string } } = {
  ...
  FR: {
    ...
    // CEO Message Page
    'careers.ceo.back': 'Retour à Apprendre les bases',
    'careers.ceo.hero.title': 'Message de Hamza Hafeez',
    'careers.ceo.hero.subtitle': 'Un message personnel de notre PDG et fondateur sur notre vision, nos valeurs et l\'avenir que nous construisons ensemble chez Upvista Digital.',
    'careers.ceo.toc.title': 'Table des matières',
    'careers.ceo.toc.welcome.title': 'Accueil personnel',
    'careers.ceo.toc.welcome.description': 'Rencontrez Hamza Hafeez et découvrez notre histoire de fondation',
    'careers.ceo.toc.journey.title': 'Notre parcours jusqu\'à présent',
    'careers.ceo.toc.journey.description': 'De la startup à l\'entreprise technologique mondiale',
    'careers.ceo.toc.vision.title': 'Notre vision pour l\'avenir',
    'careers.ceo.toc.vision.description': 'Où nous allons et ce que nous construisons',
    'careers.ceo.toc.team.title': 'Construire la bonne équipe',
    'careers.ceo.toc.team.description': 'Ce qui rend quelqu\'un parfait pour Upvista Digital',
    'careers.ceo.toc.innovation.title': 'Notre stratégie d\'innovation',
    'careers.ceo.toc.innovation.description': 'Comment nous abordons la recherche et le développement',
    'careers.ceo.toc.values.title': 'Notre engagement envers les valeurs',
    'careers.ceo.toc.values.description': 'Les principes qui guident tout ce que nous faisons',
    'careers.ceo.toc.future.title': 'Regarder vers l\'avenir',
    'careers.ceo.toc.future.description': 'Nos plans de croissance et opportunités passionnantes',
    'careers.ceo.toc.join.title': 'Rejoignez notre voyage',
    'careers.ceo.toc.join.description': 'Comment faire partie de notre mission',
    'careers.ceo.welcome.title': 'Accueil personnel',
    'careers.ceo.welcome.paragraph1': 'Bienvenue chez Upvista Digital. Je suis Hamza Hafeez, le fondateur et PDG, et je suis ravi de partager notre histoire et notre vision avec vous. Quand nous avons créé cette entreprise, nous avions une conviction simple mais profonde : la technologie devrait servir l\'humanité, et non l\'inverse.',
    'careers.ceo.welcome.paragraph2': 'Aujourd\'hui, cette conviction guide tout ce que nous faisons. Des solutions que nous créons à la culture que nous construisons, nous nous engageons à avoir un impact positif sur le monde par l\'innovation, l\'intégrité et l\'excellence. Nous croyons que les grandes entreprises technologiques sont construites par de grandes personnes, et c\'est pourquoi nous recherchons toujours des individus exceptionnels qui partagent notre vision.',
    'careers.ceo.welcome.imageAlt': 'Hamza Hafeez - PDG et fondateur d\'Upvista Digital',
    'careers.ceo.journey.title': 'Notre parcours jusqu\'à présent',
    'careers.ceo.journey.paragraph1': 'En peu de temps, Upvista Digital est passée d\'une vision audacieuse à une entreprise technologique prospère servant des clients dans plusieurs pays. Nous nous sommes établis comme un partenaire de confiance pour la transformation numérique.',
    'careers.ceo.journey.paragraph2': 'Mais notre voyage ne fait que commencer. Nous avons été témoins de première main de la façon dont la bonne technologie peut transformer les entreprises, autonomiser les individus et créer des opportunités qui n\'existaient pas auparavant. Chaque projet que nous entreprenons nous apprend quelque chose de nouveau, et chaque relation client renforce notre compréhension de ce qui est possible lorsque la créativité humaine rencontre l\'innovation technologique.',
    'careers.ceo.journey.paragraph3': 'Ce qui m\'enthousiasme le plus, c\'est que nous opérons à l\'intersection de plusieurs révolutions technologiques : l\'intelligence artificielle, le cloud computing, l\'automatisation et l\'interaction homme-machine. Cette convergence crée des opportunités sans précédent pour l\'innovation et l\'impact.',
    'careers.ceo.vision.title': 'Notre vision pour l\'avenir',
    'careers.ceo.vision.paragraph1': 'Nous envisageons un monde où la technologie s\'intègre parfaitement au potentiel humain, créant des opportunités qui étaient auparavant inimaginables. Notre objectif est d\'être à l\'avant-garde de cette transformation, non pas en tant qu\'observateurs, mais en tant qu\'architectes actifs de l\'avenir.',
    'careers.ceo.vision.paragraph2': 'Dans les années à venir, nous nous voyons étendre notre impact dans trois domaines clés : la recherche sur l\'intelligence artificielle générale, les solutions technologiques durables et la démocratisation de l\'accès aux outils numériques de pointe pour les entreprises de toutes tailles.',
    'careers.ceo.vision.quote': 'L\'avenir appartient aux organisations capables de s\'adapter, d\'innover et de croître. Notre mission est d\'aider nos clients à devenir ces organisations, tout en construisant simultanément une entreprise qui incarne ces principes dans tout ce que nous faisons.',
    'careers.ceo.team.title': 'Construire la bonne équipe',
    'careers.ceo.team.paragraph1': 'Le succès vient d\'avoir les bonnes personnes aux bons postes. Nous nous engageons à attirer, développer et retenir des talents exceptionnels qui partagent notre vision et nos valeurs. Mais qu\'est-ce qui rend quelqu\'un "bon" pour Upvista Digital?',
    'careers.ceo.team.paragraph2': 'Il ne s\'agit pas seulement de compétences techniques, bien qu\'elles soient importantes. Il s\'agit de curiosité, d\'adaptabilité et d\'un désir sincère d\'avoir un impact positif. Il s\'agit d\'être à l\'aise avec l\'ambiguïté et enthousiasmé par la possibilité de créer quelque chose qui n\'existe pas encore.',
    'careers.ceo.team.paragraph3': 'Nous recherchons des personnes qui sont des apprenants passionnés, des joueurs d\'équipe collaboratifs et des résolveurs de problèmes créatifs. Nous valorisons la diversité de pensée, de formation et d\'expérience car nous savons que les meilleures solutions émergent de perspectives diverses travaillant ensemble vers un objectif commun.',
    'careers.ceo.team.quote': 'Chaque grande innovation commence par une question simple : "Et si nous pouvions faire mieux?" C\'est la question qui guide tout ce que nous faisons, et c\'est la question que nous voulons que les membres de notre équipe posent chaque jour.',
    'careers.ceo.innovation.title': 'Notre stratégie d\'innovation',
    'careers.ceo.innovation.paragraph1': 'L\'innovation ne concerne pas seulement les nouvelles technologies, il s\'agit de nouvelles façons de penser, de nouvelles approches des problèmes et de nouvelles possibilités de croissance. Nous favorisons un environnement où l\'innovation prospère grâce à notre Upvista Technologies Lab, notre engagement envers l\'apprentissage continu et notre volonté de prendre des risques calculés.',
    'careers.ceo.innovation.paragraph2': 'Notre recherche se concentre sur les technologies émergentes comme l\'intelligence artificielle générale, l\'informatique quantique et l\'interaction homme-machine avancée. Mais nous sommes également déterminés à trouver des applications innovantes pour les technologies existantes qui peuvent résoudre plus efficacement les problèmes du monde réel.',
    'careers.ceo.innovation.paragraph3': 'Nous croyons que les meilleures innovations se produisent à l\'intersection de plusieurs disciplines. C\'est pourquoi nous encourageons la collaboration interfonctionnelle, soutenons les projets parallèles et l\'expérimentation, et maintenons des partenariats avec des institutions académiques et d\'autres organisations avant-gardistes.',
    'careers.ceo.values.title': 'Notre engagement envers les valeurs',
    'careers.ceo.values.paragraph1': 'Au fur et à mesure de notre croissance, nous restons engagés envers les valeurs fondamentales qui nous ont guidés dès le premier jour : conception centrée sur l\'humain, pratiques commerciales éthiques, travail d\'équipe collaboratif et excellence dans tout ce que nous faisons.',
    'careers.ceo.values.paragraph2': 'Nous croyons que les entreprises technologiques ont la responsabilité de considérer l\'impact plus large de leur travail. C\'est pourquoi nous priorisons la durabilité dans nos opérations, la diversité dans nos embauches et l\'accessibilité dans nos solutions. Nous ne construisons pas seulement des produits, nous construisons une entreprise dont nous sommes fiers de faire partie.',
    'careers.ceo.values.quote': 'Chez Upvista Digital, nous ne construisons pas seulement de la technologie; nous construisons des ponts entre les défis d\'aujourd\'hui et les opportunités de demain. Chaque ligne de code, chaque décision de conception et chaque relation commerciale est guidée par notre engagement à créer un changement positif.',
    'careers.ceo.future.title': 'Regarder vers l\'avenir',
    'careers.ceo.future.paragraph1': 'Les prochaines années seront transformatrices pour Upvista Digital. Nous prévoyons d\'agrandir considérablement notre équipe, de lancer de nouvelles gammes de produits et d\'approfondir nos capacités de recherche. Mais plus important encore, nous nous engageons à maintenir la culture d\'innovation, de collaboration et d\'excellence qui nous a menés jusqu\'ici.',
    'careers.ceo.future.paragraph2': 'Nous recherchons des personnes qui veulent faire partie de quelque chose de plus grand qu\'elles-mêmes... des personnes enthousiasmées par le défi de construire l\'avenir et qui croient que la technologie peut être une force pour le bien dans le monde.',
    'careers.ceo.future.paragraph3': 'Si vous lisez ce message, vous envisagez probablement de rejoindre notre équipe. Je veux que vous sachiez que nous ne cherchons pas seulement des employés, nous cherchons des partenaires dans notre mission de créer une technologie qui sert l\'humanité.',
    'careers.ceo.join.title': 'Rejoignez notre voyage',
    'careers.ceo.join.quote': 'Nous construisons un mouvement. Un mouvement vers un avenir où la technologie permet à chaque individu et organisation d\'atteindre son plein potentiel.',
    'careers.ceo.join.button': 'Rejoindre notre équipe',
  },
  ES: {
    // Header Navigation
    ...
    // CEO Message Page
    'careers.ceo.back': 'Volver a Aprender lo básico',
    'careers.ceo.hero.title': 'Mensaje de Hamza Hafeez',
    'careers.ceo.hero.subtitle': 'Un mensaje personal de nuestro CEO y fundador sobre nuestra visión, valores y el futuro que estamos construyendo juntos en Upvista Digital.',
    'careers.ceo.toc.title': 'Tabla de contenidos',
    'careers.ceo.toc.welcome.title': 'Bienvenida personal',
    'careers.ceo.toc.welcome.description': 'Conoce a Hamza Hafeez y aprende sobre nuestra historia de fundación',
    'careers.ceo.toc.journey.title': 'Nuestro viaje hasta ahora',
    'careers.ceo.toc.journey.description': 'De startup a empresa tecnológica global',
    'careers.ceo.toc.vision.title': 'Nuestra visión para el futuro',
    'careers.ceo.toc.vision.description': 'Hacia dónde nos dirigimos y qué estamos construyendo',
    'careers.ceo.toc.team.title': 'Construyendo el equipo adecuado',
    'careers.ceo.toc.team.description': 'Qué hace que alguien sea perfecto para Upvista Digital',
    'careers.ceo.toc.innovation.title': 'Nuestra estrategia de innovación',
    'careers.ceo.toc.innovation.description': 'Cómo abordamos la investigación y el desarrollo',
    'careers.ceo.toc.values.title': 'Nuestro compromiso con los valores',
    'careers.ceo.toc.values.description': 'Los principios que guían todo lo que hacemos',
    'careers.ceo.toc.future.title': 'Mirando hacia adelante',
    'careers.ceo.toc.future.description': 'Nuestros planes de crecimiento y oportunidades emocionantes',
    'careers.ceo.toc.join.title': 'Únete a nuestro viaje',
    'careers.ceo.toc.join.description': 'Cómo convertirse en parte de nuestra misión',
    'careers.ceo.welcome.title': 'Bienvenida personal',
    'careers.ceo.welcome.paragraph1': 'Bienvenido a Upvista Digital. Soy Hamza Hafeez, el fundador y CEO, y estoy emocionado de compartir nuestra historia y visión contigo. Cuando comenzamos esta empresa, teníamos una creencia simple pero profunda: la tecnología debería servir a la humanidad, no al revés.',
    'careers.ceo.welcome.paragraph2': 'Hoy, esa creencia impulsa todo lo que hacemos. Desde las soluciones que creamos hasta la cultura que construimos, estamos comprometidos a tener un impacto positivo en el mundo a través de la innovación, integridad y excelencia. Creemos que las grandes empresas tecnológicas se construyen sobre grandes personas, y por eso siempre estamos buscando individuos excepcionales que compartan nuestra visión.',
    'careers.ceo.welcome.imageAlt': 'Hamza Hafeez - CEO y fundador de Upvista Digital',
    'careers.ceo.journey.title': 'Nuestro viaje hasta ahora',
    'careers.ceo.journey.paragraph1': 'En poco tiempo, Upvista Digital ha crecido de una visión audaz a una próspera empresa tecnológica que sirve a clientes en múltiples países. Nos hemos establecido como un socio confiable para la transformación digital.',
    'careers.ceo.journey.paragraph2': 'Pero nuestro viaje apenas está comenzando. Hemos sido testigos de primera mano de cómo la tecnología adecuada puede transformar negocios, empoderar individuos y crear oportunidades que no existían antes. Cada proyecto que emprendemos nos enseña algo nuevo, y cada relación con clientes fortalece nuestra comprensión de lo que es posible cuando la creatividad humana se encuentra con la innovación tecnológica.',
    'careers.ceo.journey.paragraph3': 'Lo que más me emociona es que estamos operando en la intersección de múltiples revoluciones tecnológicas: inteligencia artificial, computación en la nube, automatización e interacción humano-computadora. Esta convergencia crea oportunidades sin precedentes para la innovación y el impacto.',
    'careers.ceo.vision.title': 'Nuestra visión para el futuro',
    'careers.ceo.vision.paragraph1': 'Imaginamos un mundo donde la tecnología se integra perfectamente con el potencial humano, creando oportunidades que antes eran inimaginables. Nuestro objetivo es estar a la vanguardia de esta transformación, no solo como observadores, sino como arquitectos activos del futuro.',
    'careers.ceo.vision.paragraph2': 'En los próximos años, nos vemos expandiendo nuestro impacto en tres áreas clave: investigación de inteligencia artificial general, soluciones tecnológicas sostenibles y democratización del acceso a herramientas digitales de vanguardia para empresas de todos los tamaños.',
    'careers.ceo.vision.quote': 'El futuro pertenece a las organizaciones que pueden adaptarse, innovar y crecer. Nuestra misión es ayudar a nuestros clientes a convertirse en esas organizaciones, mientras simultáneamente construimos una empresa que encarna estos principios en todo lo que hacemos.',
    'careers.ceo.team.title': 'Construyendo el equipo adecuado',
    'careers.ceo.team.paragraph1': 'El éxito proviene de tener las personas adecuadas en los roles adecuados. Estamos comprometidos a atraer, desarrollar y retener talento excepcional que comparta nuestra visión y valores. Pero, ¿qué hace que alguien sea "adecuado" para Upvista Digital?',
    'careers.ceo.team.paragraph2': 'No se trata solo de habilidades técnicas, aunque son importantes. Se trata de curiosidad, adaptabilidad y un deseo genuino de tener un impacto positivo. Se trata de sentirse cómodo con la ambigüedad y emocionarse con la posibilidad de crear algo que aún no existe.',
    'careers.ceo.team.paragraph3': 'Buscamos personas que sean aprendices apasionados, jugadores de equipo colaborativos y solucionadores de problemas creativos. Valoramos la diversidad de pensamiento, antecedentes y experiencia porque sabemos que las mejores soluciones emergen de perspectivas diversas trabajando juntas hacia un objetivo común.',
    'careers.ceo.team.quote': 'Cada gran innovación comienza con una pregunta simple: "¿Y si pudiéramos hacerlo mejor?" Esa es la pregunta que impulsa todo lo que hacemos, y es la pregunta que queremos que los miembros de nuestro equipo hagan todos los días.',
    'careers.ceo.innovation.title': 'Nuestra estrategia de innovación',
    'careers.ceo.innovation.paragraph1': 'La innovación no se trata solo de nueva tecnología, se trata de nuevas formas de pensar, nuevos enfoques de problemas y nuevas posibilidades de crecimiento. Fomentamos un ambiente donde la innovación prospera a través de nuestro Upvista Technologies Lab, nuestro compromiso con el aprendizaje continuo y nuestra disposición a tomar riesgos calculados.',
    'careers.ceo.innovation.paragraph2': 'Nuestra investigación se centra en tecnologías emergentes como inteligencia artificial general, computación cuántica e interacción humano-computadora avanzada. Pero estamos igualmente comprometidos a encontrar aplicaciones innovadoras para tecnologías existentes que puedan resolver problemas del mundo real de manera más efectiva.',
    'careers.ceo.innovation.paragraph3': 'Creemos que las mejores innovaciones suceden en la intersección de múltiples disciplinas. Por eso fomentamos la colaboración interfuncional, apoyamos proyectos paralelos y experimentación, y mantenemos asociaciones con instituciones académicas y otras organizaciones con visión de futuro.',
    'careers.ceo.values.title': 'Nuestro compromiso con los valores',
    'careers.ceo.values.paragraph1': 'A medida que crecemos, seguimos comprometidos con los valores fundamentales que nos han guiado desde el primer día: diseño centrado en el ser humano, prácticas comerciales éticas, trabajo en equipo colaborativo y excelencia en todo lo que hacemos.',
    'careers.ceo.values.paragraph2': 'Creemos que las empresas tecnológicas tienen la responsabilidad de considerar el impacto más amplio de su trabajo. Por eso priorizamos la sostenibilidad en nuestras operaciones, la diversidad en nuestras contrataciones y la accesibilidad en nuestras soluciones. No solo estamos construyendo productos, estamos construyendo una empresa de la que estamos orgullosos de ser parte.',
    'careers.ceo.values.quote': 'En Upvista Digital, no solo construimos tecnología; construimos puentes entre los desafíos de hoy y las oportunidades del mañana. Cada línea de código, cada decisión de diseño y cada relación comercial está guiada por nuestro compromiso de crear un cambio positivo.',
    'careers.ceo.future.title': 'Mirando hacia adelante',
    'careers.ceo.future.paragraph1': 'Los próximos años serán transformadores para Upvista Digital. Planeamos expandir significativamente nuestro equipo, lanzar nuevas líneas de productos y profundizar nuestras capacidades de investigación. Pero más importante aún, estamos comprometidos a mantener la cultura de innovación, colaboración y excelencia que nos ha traído hasta aquí.',
    'careers.ceo.future.paragraph2': 'Buscamos personas que quieran ser parte de algo más grande que ellos mismos... personas que se emocionen con el desafío de construir el futuro y que crean que la tecnología puede ser una fuerza para el bien en el mundo.',
    'careers.ceo.future.paragraph3': 'Si estás leyendo este mensaje, probablemente estés considerando unirte a nuestro equipo. Quiero que sepas que no solo estamos buscando empleados, estamos buscando socios en nuestra misión de crear tecnología que sirva a la humanidad.',
    'careers.ceo.join.title': 'Únete a nuestro viaje',
    'careers.ceo.join.quote': 'Estamos construyendo un movimiento. Un movimiento hacia un futuro donde la tecnología empodera a cada individuo y organización para alcanzar su máximo potencial.',
    'careers.ceo.join.button': 'Únete a nuestro equipo',
  },
  TR: {
    // Header Navigation
    ...
    // CEO Message Page
    'careers.ceo.back': 'Temelleri Öğren\'e Dön',
    'careers.ceo.hero.title': 'Hamza Hafeez\'den Mesaj',
    'careers.ceo.hero.subtitle': 'CEO ve kurucumuzdan Upvista Digital\'da birlikte inşa ettiğimiz vizyonumuz, değerlerimiz ve gelecek hakkında kişisel bir mesaj.',
    'careers.ceo.toc.title': 'İçindekiler',
    'careers.ceo.toc.welcome.title': 'Kişisel Karşılama',
    'careers.ceo.toc.welcome.description': 'Hamza Hafeez ile tanışın ve kuruluş hikayemizi öğrenin',
    'careers.ceo.toc.journey.title': 'Şimdiye Kadarki Yolculuğumuz',
    'careers.ceo.toc.journey.description': 'Startup\'tan küresel teknoloji şirketine',
    'careers.ceo.toc.vision.title': 'Gelecek İçin Vizyonumuz',
    'careers.ceo.toc.vision.description': 'Nereye gidiyoruz ve ne inşa ediyoruz',
    'careers.ceo.toc.team.title': 'Doğru Ekibi Kurmak',
    'careers.ceo.toc.team.description': 'Birini Upvista Digital için mükemmel yapan nedir',
    'careers.ceo.toc.innovation.title': 'İnovasyon Stratejimiz',
    'careers.ceo.toc.innovation.description': 'Araştırma ve geliştirmeye nasıl yaklaşıyoruz',
    'careers.ceo.toc.values.title': 'Değerlere Bağlılığımız',
    'careers.ceo.toc.values.description': 'Yaptığımız her şeyi yönlendiren ilkeler',
    'careers.ceo.toc.future.title': 'İleriye Bakmak',
    'careers.ceo.toc.future.description': 'Büyüme planlarımız ve heyecan verici fırsatlar',
    'careers.ceo.toc.join.title': 'Yolculuğumuza Katılın',
    'careers.ceo.toc.join.description': 'Misyonumuzun bir parçası nasıl olunur',
    'careers.ceo.welcome.title': 'Kişisel Karşılama',
    'careers.ceo.welcome.paragraph1': 'Upvista Digital\'a hoş geldiniz. Ben Hamza Hafeez, kurucu ve CEO, ve hikayemizi ve vizyonumuzu sizinle paylaşmaktan heyecan duyuyorum. Bu şirketi kurduğumuzda, basit ama derin bir inancımız vardı: teknoloji insanlığa hizmet etmeli, tam tersi değil.',
    'careers.ceo.welcome.paragraph2': 'Bugün, bu inanç yaptığımız her şeyi yönlendiriyor. Yarattığımız çözümlerden inşa ettiğimiz kültüre kadar, inovasyon, dürüstlük ve mükemmellik yoluyla dünya üzerinde olumlu bir etki yaratmaya kararlıyız. Büyük teknoloji şirketlerinin büyük insanlar üzerine inşa edildiğine inanıyoruz ve bu yüzden her zaman vizyonumuzu paylaşan olağanüstü bireyler arıyoruz.',
    'careers.ceo.welcome.imageAlt': 'Hamza Hafeez - Upvista Digital CEO ve Kurucusu',
    'careers.ceo.journey.title': 'Şimdiye Kadarki Yolculuğumuz',
    'careers.ceo.journey.paragraph1': 'Kısa sürede, Upvista Digital cesur bir vizyondan birden fazla ülkedeki müşterilere hizmet veren gelişen bir teknoloji şirketine dönüştü. Kendimizi dijital dönüşüm için güvenilir bir ortak olarak kurduk.',
    'careers.ceo.journey.paragraph2': 'Ama yolculuğumuz daha yeni başlıyor. Doğru teknolojinin işletmeleri nasıl dönüştürebileceğini, bireyleri nasıl güçlendirebileceğini ve daha önce var olmayan fırsatlar yaratabileceğini ilk elden gördük. Üstlendiğimiz her proje bize yeni bir şey öğretiyor ve her müşteri ilişkisi, insan yaratıcılığı teknolojik yenilikle buluştuğunda neyin mümkün olduğuna dair anlayışımızı güçlendiriyor.',
    'careers.ceo.journey.paragraph3': 'Beni en çok heyecanlandıran şey, birden fazla teknolojik devrimin kesişiminde faaliyet gösteriyor olmamız: yapay zeka, bulut bilişim, otomasyon ve insan-bilgisayar etkileşimi. Bu yakınsama, inovasyon ve etki için benzeri görülmemiş fırsatlar yaratıyor.',
    'careers.ceo.vision.title': 'Gelecek İçin Vizyonumuz',
    'careers.ceo.vision.paragraph1': 'Teknolojinin insan potansiyeliyle sorunsuz bir şekilde entegre olduğu, daha önce hayal edilemez olan fırsatlar yaratan bir dünya hayal ediyoruz. Hedefimiz bu dönüşümün ön saflarında olmak, sadece gözlemciler olarak değil, geleceğin aktif mimarları olarak.',
    'careers.ceo.vision.paragraph2': 'Önümüzdeki yıllarda kendimizi üç ana alanda etkimizi genişletirken görüyoruz: yapay genel zeka araştırması, sürdürülebilir teknoloji çözümleri ve her büyüklükteki işletme için son teknoloji dijital araçlara erişimin demokratikleştirilmesi.',
    'careers.ceo.vision.quote': 'Gelecek, uyum sağlayabilen, yenilik yapabilen ve büyüyebilen organizasyonlara aittir. Misyonumuz, müşterilerimizin bu organizasyonlar olmasına yardımcı olmak ve aynı zamanda yaptığımız her şeyde bu ilkeleri somutlaştıran bir şirket inşa etmektir.',
    'careers.ceo.team.title': 'Doğru Ekibi Kurmak',
    'careers.ceo.team.paragraph1': 'Başarı, doğru rollerde doğru insanlara sahip olmaktan gelir. Vizyonumuzu ve değerlerimizi paylaşan olağanüstü yetenekleri çekmeye, geliştirmeye ve elde tutmaya kararlıyız. Peki birini Upvista Digital için "doğru" yapan nedir?',
    'careers.ceo.team.paragraph2': 'Sadece teknik becerilerle ilgili değil, bunlar önemli olsa da. Merak, uyum sağlama yeteneği ve olumlu bir etki yaratma konusunda gerçek bir istek hakkında. Belirsizlikle rahat olmak ve henüz var olmayan bir şey yaratma olasılığından heyecan duymak hakkında.',
    'careers.ceo.team.paragraph3': 'Tutkulu öğrenenler, işbirlikçi takım oyuncuları ve yaratıcı problem çözücüler olan insanlar arıyoruz. Düşünce, geçmiş ve deneyim çeşitliliğine değer veriyoruz çünkü en iyi çözümlerin ortak bir hedefe doğru birlikte çalışan çeşitli bakış açılarından ortaya çıktığını biliyoruz.',
    'careers.ceo.team.quote': 'Her büyük inovasyon basit bir soruyla başlar: "Daha iyi yapabilir miydik?" Bu, yaptığımız her şeyi yönlendiren soru ve ekip üyelerimizin her gün sormasını istediğimiz soru.',
    'careers.ceo.innovation.title': 'İnovasyon Stratejimiz',
    'careers.ceo.innovation.paragraph1': 'İnovasyon sadece yeni teknoloji hakkında değil, yeni düşünme yolları, problemlere yeni yaklaşımlar ve büyüme için yeni olasılıklar hakkında. Upvista Technologies Lab, sürekli öğrenmeye olan bağlılığımız ve hesaplanmış riskler alma istekliliğimiz sayesinde inovasyonun geliştiği bir ortam yaratıyoruz.',
    'careers.ceo.innovation.paragraph2': 'Araştırmamız yapay genel zeka, kuantum bilişim ve gelişmiş insan-bilgisayar etkileşimi gibi gelişmekte olan teknolojilere odaklanıyor. Ancak gerçek dünya sorunlarını daha etkili bir şekilde çözebilecek mevcut teknolojiler için yenilikçi uygulamalar bulmaya da aynı derecede kararlıyız.',
    'careers.ceo.innovation.paragraph3': 'En iyi inovasyonların birden fazla disiplinin kesişiminde gerçekleştiğine inanıyoruz. Bu yüzden işlevler arası işbirliğini teşvik ediyor, yan projeleri ve deneyleri destekliyor ve akademik kurumlar ve diğer ileriye dönük kuruluşlarla ortaklıkları sürdürüyoruz.',
    'careers.ceo.values.title': 'Değerlere Bağlılığımız',
    'careers.ceo.values.paragraph1': 'Büyüdükçe, bizi ilk günden itibaren yönlendiren temel değerlere bağlı kalmaya devam ediyoruz: insan merkezli tasarım, etik iş uygulamaları, işbirlikçi ekip çalışması ve yaptığımız her şeyde mükemmellik.',
    'careers.ceo.values.paragraph2': 'Teknoloji şirketlerinin çalışmalarının daha geniş etkisini düşünme sorumluluğu olduğuna inanıyoruz. Bu yüzden operasyonlarımızda sürdürülebilirliğe, işe alımlarımızda çeşitliliğe ve çözümlerimizde erişilebilirliğe öncelik veriyoruz. Sadece ürünler inşa etmiyoruz, parçası olmaktan gurur duyduğumuz bir şirket inşa ediyoruz.',
    'careers.ceo.values.quote': 'Upvista Digital\'da sadece teknoloji inşa etmiyoruz; bugünün zorlukları ile yarının fırsatları arasında köprüler kuruyoruz. Her kod satırı, her tasarım kararı ve her iş ilişkisi, olumlu değişim yaratma taahhüdümüz tarafından yönlendirilir.',
    'careers.ceo.future.title': 'İleriye Bakmak',
    'careers.ceo.future.paragraph1': 'Önümüzdeki birkaç yıl Upvista Digital için dönüştürücü olacak. Ekibimizi önemli ölçüde genişletmeyi, yeni ürün hatları başlatmayı ve araştırma yeteneklerimizi derinleştirmeyi planlıyoruz. Ancak daha da önemlisi, bizi buraya getiren inovasyon, işbirliği ve mükemmellik kültürünü sürdürmeye kararlıyız.',
    'careers.ceo.future.paragraph2': 'Kendilerinden daha büyük bir şeyin parçası olmak isteyen insanlar arıyoruz... geleceği inşa etme meydan okumasından heyecan duyan ve teknolojinin dünyada iyilik için bir güç olabileceğine inanan insanlar.',
    'careers.ceo.future.paragraph3': 'Bu mesajı okuyorsanız, muhtemelen ekibimize katılmayı düşünüyorsunuzdur. Bilmenizi isterim ki sadece çalışan aramıyoruz, insanlığa hizmet eden teknoloji yaratma misyonumuzda ortaklar arıyoruz.',
    'careers.ceo.join.title': 'Yolculuğumuza Katılın',
    'careers.ceo.join.quote': 'Bir hareket inşa ediyoruz. Teknolojinin her bireyi ve organizasyonu tam potansiyeline ulaşmalarını sağladığı bir geleceğe doğru bir hareket.',
    'careers.ceo.join.button': 'Ekibimize Katılın',
  },
  UR: {
    // Header Navigation
    ...
    // CEO Message Page
    'careers.ceo.back': 'بنیادی باتیں سیکھیں پر واپس جائیں',
    'careers.ceo.hero.title': 'حمزہ حفیظ کا پیغام',
    'careers.ceo.hero.subtitle': 'ہمارے CEO اور بانی کی طرف سے ہمارے وژن، اقدار، اور اس مستقبل کے بارے میں ایک ذاتی پیغام جو ہم Upvista Digital میں مل کر بنا رہے ہیں۔',
    'careers.ceo.toc.title': 'فہرست مضامین',
    'careers.ceo.toc.welcome.title': 'ذاتی خوش آمدید',
    'careers.ceo.toc.welcome.description': 'حمزہ حفیظ سے ملیں اور ہماری بنیاد کی کہانی جانیں',
    'careers.ceo.toc.journey.title': 'اب تک کا ہمارا سفر',
    'careers.ceo.toc.journey.description': 'اسٹارٹ اپ سے عالمی ٹیکنالوجی کمپنی تک',
    'careers.ceo.toc.vision.title': 'مستقبل کے لیے ہمارا وژن',
    'careers.ceo.toc.vision.description': 'ہم کہاں جا رہے ہیں اور کیا بنا رہے ہیں',
    'careers.ceo.toc.team.title': 'صحیح ٹیم بنانا',
    'careers.ceo.toc.team.description': 'کسی کو Upvista Digital کے لیے کامل کیا بناتا ہے',
    'careers.ceo.toc.innovation.title': 'ہماری اختراع کی حکمت عملی',
    'careers.ceo.toc.innovation.description': 'ہم تحقیق اور ترقی کو کیسے اپروچ کرتے ہیں',
    'careers.ceo.toc.values.title': 'اقدار کے لیے ہماری وابستگی',
    'careers.ceo.toc.values.description': 'وہ اصول جو ہمارے ہر کام کی رہنمائی کرتے ہیں',
    'careers.ceo.toc.future.title': 'آگے دیکھنا',
    'careers.ceo.toc.future.description': 'ہماری ترقی کے منصوبے اور دلچسپ مواقع',
    'careers.ceo.toc.join.title': 'ہمارے سفر میں شامل ہوں',
    'careers.ceo.toc.join.description': 'ہمارے مشن کا حصہ کیسے بنیں',
    'careers.ceo.welcome.title': 'ذاتی خوش آمدید',
    'careers.ceo.welcome.paragraph1': 'Upvista Digital میں خوش آمدید۔ میں حمزہ حفیظ ہوں، بانی اور CEO، اور میں آپ کے ساتھ اپنی کہانی اور وژن شیئر کرنے کے لیے پرجوش ہوں۔ جب ہم نے اس کمپنی کو شروع کیا، ہمارے پاس ایک سادہ لیکن گہرا عقیدہ تھا: ٹیکنالوجی کو انسانیت کی خدمت کرنی چاہیے، نہ کہ اس کے برعکس۔',
    'careers.ceo.welcome.paragraph2': 'آج، یہ عقیدہ وہ سب کچھ چلاتا ہے جو ہم کرتے ہیں۔ ہم جو حل بناتے ہیں سے لے کر جو ثقافت ہم تعمیر کرتے ہیں تک، ہم جدت، دیانتداری، اور بہترینیت کے ذریعے دنیا پر مثبت اثر ڈالنے کے لیے پرعزم ہیں۔ ہم یقین رکھتے ہیں کہ عظیم ٹیکنالوجی کمپنیاں عظیم لوگوں پر بنائی جاتی ہیں، اور یہی وجہ ہے کہ ہم ہمیشہ غیر معمولی افراد کی تلاش میں ہیں جو ہمارے وژن کو شیئر کرتے ہیں۔',
    'careers.ceo.welcome.imageAlt': 'حمزہ حفیظ - Upvista Digital کے CEO اور بانی',
    'careers.ceo.journey.title': 'اب تک کا ہمارا سفر',
    'careers.ceo.journey.paragraph1': 'بس تھوڑے سے وقت میں، Upvista Digital ایک جرات مندانہ وژن سے ایک کامیاب ٹیکنالوجی کمپنی بن گئی ہے جو متعدد ممالک میں کلائنٹس کو خدمات فراہم کرتی ہے۔ ہم نے اپنے آپ کو ڈیجیٹل تبدیلی کے لیے ایک قابل اعتماد ساتھی کے طور پر قائم کیا ہے۔',
    'careers.ceo.journey.paragraph2': 'لیکن ہمارا سفر ابھی شروع ہوا ہے۔ ہم نے براہ راست دیکھا ہے کہ صحیح ٹیکنالوجی کاروبار کو کیسے تبدیل کر سکتی ہے، افراد کو بااختیار بنا سکتی ہے، اور ایسے مواقع پیدا کر سکتی ہے جو پہلے موجود نہیں تھے۔ ہر پروجیکٹ جو ہم لیتے ہیں وہ ہمیں کچھ نیا سکھاتا ہے، اور ہر کلائنٹ تعلق ہماری سمجھ کو مضبوط کرتا ہے کہ جب انسانی تخلیقیت ٹیکنالوجیکل اختراع سے ملتی ہے تو کیا ممکن ہے۔',
    'careers.ceo.journey.paragraph3': 'مجھے سب سے زیادہ جوش دلانے والی بات یہ ہے کہ ہم متعدد ٹیکنالوجی انقلابات کے سنگم پر کام کر رہے ہیں: مصنوعی ذہانت، کلاؤڈ کمپیوٹنگ، آٹومیشن، اور انسان اور کمپیوٹر کی بات چیت۔ یہ اکٹھا ہونا اختراع اور اثر کے لیے بے مثال مواقع پیدا کرتا ہے۔',
    'careers.ceo.vision.title': 'مستقبل کے لیے ہمارا وژن',
    'careers.ceo.vision.paragraph1': 'ہم ایک ایسی دنیا کا تصور کرتے ہیں جہاں ٹیکنالوجی انسانی صلاحیت کے ساتھ بغیر کسی رکاوٹ کے ضم ہو جاتی ہے، ایسے مواقع پیدا کرتی ہے جو پہلے ناقابل تصور تھے۔ ہمارا مقصد اس تبدیلی میں سب سے آگے ہونا ہے، صرف مشاہدہ کار کے طور پر نہیں، بلکہ مستقبل کے فعال معماروں کے طور پر۔',
    'careers.ceo.vision.paragraph2': 'آنے والے سالوں میں، ہم اپنے آپ کو تین اہم شعبوں میں اپنا اثر بڑھاتے ہوئے دیکھتے ہیں: مصنوعی عمومی ذہانت کی تحقیق، پائیدار ٹیکنالوجی حل، اور ہر سائز کے کاروبار کے لیے جدید ترین ڈیجیٹل ٹولز تک رسائی کو جمہوری بنانا۔',
    'careers.ceo.vision.quote': 'مستقبل ان تنظیموں کا ہے جو موافقت، اختراع، اور ترقی کر سکتی ہیں۔ ہمارا مشن اپنے کلائنٹس کی مدد کرنا ہے کہ وہ ایسی تنظیمیں بنیں، اور ساتھ ہی ساتھ ایک ایسی کمپنی بنانا جو ہم جو کچھ بھی کرتے ہیں اس میں ان اصولوں کو مجسم کرے۔',
    'careers.ceo.team.title': 'صحیح ٹیم بنانا',
    'careers.ceo.team.paragraph1': 'کامیابی صحیح کرداروں میں صحیح لوگوں کے ہونے سے آتی ہے۔ ہم ایسے غیر معمولی ٹیلنٹ کو راغب کرنے، ترقی دینے، اور برقرار رکھنے کے لیے پرعزم ہیں جو ہمارے وژن اور اقدار کو شیئر کرتے ہیں۔ لیکن کسی کو Upvista Digital کے لیے "صحیح" کیا بناتا ہے؟',
    'careers.ceo.team.paragraph2': 'یہ صرف تکنیکی مہارتوں کے بارے میں نہیں ہے، حالانکہ وہ اہم ہیں۔ یہ تجسس، موافقت، اور مثبت اثر ڈالنے کی حقیقی خواہش کے بارے میں ہے۔ یہ ابہام کے ساتھ آرام دہ ہونے اور کچھ ایسا بنانے کے امکان سے پرجوش ہونے کے بارے میں ہے جو ابھی تک موجود نہیں ہے۔',
    'careers.ceo.team.paragraph3': 'ہم ایسے لوگوں کی تلاش میں ہیں جو پرجوش سیکھنے والے، تعاون کرنے والے ٹیم کھلاڑی، اور تخلیقی مسئلہ حل کرنے والے ہیں۔ ہم سوچ، پس منظر، اور تجربے کی تنوع کی قدر کرتے ہیں کیونکہ ہم جانتے ہیں کہ بہترین حل مختلف نقطہ نظر سے ایک مشترکہ مقصد کی طرف مل کر کام کرنے سے ابھرتے ہیں۔',
    'careers.ceo.team.quote': 'ہر عظیم اختراع ایک سادہ سوال سے شروع ہوتی ہے: "کیا ہو اگر ہم بہتر کر سکتے؟" یہ وہ سوال ہے جو ہم جو کچھ بھی کرتے ہیں اسے چلاتا ہے، اور یہ وہ سوال ہے جو ہم چاہتے ہیں کہ ہماری ٹیم کے ممبران ہر روز پوچھیں۔',
    'careers.ceo.innovation.title': 'ہماری اختراع کی حکمت عملی',
    'careers.ceo.innovation.paragraph1': 'اختراع صرف نئی ٹیکنالوجی کے بارے میں نہیں ہے، یہ سوچنے کے نئے طریقوں، مسائل کے نئے نقطہ نظر، اور ترقی کے نئے امکانات کے بارے میں ہے۔ ہم ایک ایسا ماحول پروان چڑھاتے ہیں جہاں اختراع ہماری Upvista Technologies Lab، مسلسل سیکھنے کی ہماری وابستگی، اور حساب شدہ خطرات لینے کی ہماری تیاری کے ذریعے پھلتی پھولتی ہے۔',
    'careers.ceo.innovation.paragraph2': 'ہماری تحقیق ابھرتی ہوئی ٹیکنالوجیز جیسے مصنوعی عمومی ذہانت، کوانٹم کمپیوٹنگ، اور جدید انسان-کمپیوٹر تعامل پر مرکوز ہے۔ لیکن ہم موجودہ ٹیکنالوجیز کے لیے جدید ایپلیکیشنز تلاش کرنے کے لیے بھی اتنے ہی پرعزم ہیں جو حقیقی دنیا کے مسائل کو زیادہ مؤثر طریقے سے حل کر سکیں۔',
    'careers.ceo.innovation.paragraph3': 'ہم یقین رکھتے ہیں کہ بہترین اختراعات متعدد مضامین کے سنگم پر ہوتی ہیں۔ یہی وجہ ہے کہ ہم کراس فنکشنل تعاون کی حوصلہ افزائی کرتے ہیں، سائیڈ پروجیکٹس اور تجربات کی حمایت کرتے ہیں، اور تعلیمی اداروں اور دیگر آگے کی سوچ رکھنے والی تنظیموں کے ساتھ شراکت داری برقرار رکھتے ہیں۔',
    'careers.ceo.values.title': 'اقدار کے لیے ہماری وابستگی',
    'careers.ceo.values.paragraph1': 'جیسے جیسے ہم بڑھتے ہیں، ہم ان بنیادی اقدار کے ساتھ وابستہ رہتے ہیں جنہوں نے پہلے دن سے ہماری رہنمائی کی ہے: انسان محور ڈیزائن، اخلاقی کاروباری طریقے، تعاونی ٹیم ورک، اور ہر اس کام میں بہترینیت جو ہم کرتے ہیں۔',
    'careers.ceo.values.paragraph2': 'ہم یقین رکھتے ہیں کہ ٹیکنالوجی کمپنیوں کی ذمہ داری ہے کہ وہ اپنے کام کے وسیع تر اثرات پر غور کریں۔ یہی وجہ ہے کہ ہم اپنی کارروائیوں میں پائیداری، اپنی بھرتی میں تنوع، اور اپنے حلوں میں رسائی کو ترجیح دیتے ہیں۔ ہم صرف مصنوعات نہیں بنا رہے، ہم ایک ایسی کمپنی بنا رہے ہیں جس کا حصہ ہونے پر ہمیں فخر ہے۔',
    'careers.ceo.values.quote': 'Upvista Digital میں، ہم صرف ٹیکنالوجی نہیں بناتے؛ ہم آج کے چیلنجز اور کل کے مواقع کے درمیان پل بناتے ہیں۔ ہر کوڈ کی لائن، ہر ڈیزائن کا فیصلہ، اور ہر کاروباری تعلق مثبت تبدیلی پیدا کرنے کی ہماری وابستگی سے رہنمائی حاصل کرتا ہے۔',
    'careers.ceo.future.title': 'آگے دیکھنا',
    'careers.ceo.future.paragraph1': 'اگلے کچھ سال Upvista Digital کے لیے تبدیلی کے حامل ہوں گے۔ ہم اپنی ٹیم کو نمایاں طور پر بڑھانے، نئی پروڈکٹ لائنز لانچ کرنے، اور اپنی تحقیقی صلاحیتوں کو گہرا کرنے کا ارادہ رکھتے ہیں۔ لیکن اس سے بھی اہم بات یہ ہے کہ ہم اختراع، تعاون، اور بہترینیت کی ثقافت کو برقرار رکھنے کے لیے پرعزم ہیں جو ہمیں یہاں تک لائی ہے۔',
    'careers.ceo.future.paragraph2': 'ہم ایسے لوگوں کی تلاش میں ہیں جو اپنے آپ سے بڑی کسی چیز کا حصہ بننا چاہتے ہیں... ایسے لوگ جو مستقبل کی تعمیر کے چیلنج سے پرجوش ہیں اور یقین رکھتے ہیں کہ ٹیکنالوجی دنیا میں بھلائی کی طاقت ہو سکتی ہے۔',
    'careers.ceo.future.paragraph3': 'اگر آپ یہ پیغام پڑھ رہے ہیں، تو آپ شاید ہماری ٹیم میں شامل ہونے پر غور کر رہے ہیں۔ میں چاہتا ہوں کہ آپ جانیں کہ ہم صرف ملازمین نہیں تلاش کر رہے، ہم اپنے مشن میں شراکت دار تلاش کر رہے ہیں تاکہ ایسی ٹیکنالوجی بنائیں جو انسانیت کی خدمت کرے۔',
    'careers.ceo.join.title': 'ہمارے سفر میں شامل ہوں',
    'careers.ceo.join.quote': 'ہم ایک تحریک بنا رہے ہیں۔ ایک ایسے مستقبل کی طرف تحریک جہاں ٹیکنالوجی ہر فرد اور تنظیم کو ان کی مکمل صلاحیت تک پہنچنے کا اختیار دیتی ہے۔',
    'careers.ceo.join.button': 'ہماری ٹیم میں شامل ہوں',
  },
};
