            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className={isDark ? 'text-gray-300' : 'text-gray-700'}>Demonstrate your full-stack development skills through our comprehensive technical challenges covering frontend, backend, and database technologies.</p>
                </div>
              </div>
          ...
          >
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-4">
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Develop and maintain full-stack web applications using modern frameworks and technologies</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Design and implement responsive user interfaces with optimal user experience</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Build robust backend APIs and database architectures</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Collaborate with designers, product managers, and other developers</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Optimize applications for maximum speed and scalability</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Implement security and data protection measures</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Participate in code reviews and contribute to technical documentation</li>
              </ul>
            </div>
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-4">
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Proficiency in frontend technologies (React, Vue, Angular, HTML5, CSS3, JavaScript/TypeScript)</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Strong backend development skills (Node.js, Python, Java, or .NET)</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Experience with databases (PostgreSQL, MySQL, MongoDB, Redis)</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Knowledge of RESTful APIs, GraphQL, and microservices architecture</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Experience with version control systems (Git) and collaborative development</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Understanding of web security principles and best practices</li>
              </ul>
            </div>
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-4">
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Experience with cloud platforms (AWS, Azure, Google Cloud)</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Knowledge of containerization and orchestration (Docker, Kubernetes)</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Experience with testing frameworks and CI/CD pipelines</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Understanding of DevOps practices and infrastructure as code</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Experience with mobile app development (React Native, Flutter)</li>
              </ul>
            </div>
          </motion.div>
        </div>
