          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
            ...
            >
              <h1 className={`text-5xl md:text-7xl font-bold mb-8 drop-shadow-2xl ${isDark ? 'text-white' : 'text-gray-900'}`}>
                {t('careers.departments.uiux.hero.title')}
              </h1>
              <p className={`text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed drop-shadow-lg mb-12 ${isDark ? 'text-gray-200' : 'text-gray-700'}`}>
                {t('careers.departments.uiux.hero.subtitle')}
              </p>
          ...
          <div className="space-y-24">
            ...
            >
              <div className="text-center mb-16">
                <h2 className={`text-4xl md:text-5xl font-bold mb-6 ${isDark ? 'text-white' : 'text-gray-900'}`}>{t('careers.departments.uiux.about.title')}</h2>
              ...
              <div className={`space-y-8 text-lg leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                <p>
                  {t('careers.departments.uiux.about.p1')}
                </p>
                <p>
                  {t('careers.departments.uiux.about.p2')}
                </p>
                <p>
                  {t('careers.departments.uiux.about.p3')}
                </p>
              </div>
            </motion.section>
            ...
            >
              ...
              <div className="space-y-8">
                <div className={`border-l-4 pl-6 ${isDark ? 'border-purple-500' : 'border-purple-400'}`}>
                  <h3 className={`text-2xl font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>{t('careers.departments.uiux.activities.research.title')}</h3>
                  <p className={`leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                    {t('careers.departments.uiux.activities.research.desc')}
                  </p>
                </div>
                
                <div className={`border-l-4 pl-6 ${isDark ? 'border-purple-500' : 'border-purple-400'}`}>
                  <h3 className={`text-2xl font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>{t('careers.departments.uiux.activities.interface.title')}</h3>
                  <p className={`leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                    {t('careers.departments.uiux.activities.interface.desc')}
                  </p>
                </div>
                
                <div className={`border-l-4 pl-6 ${isDark ? 'border-purple-500' : 'border-purple-400'}`}>
                  <h3 className={`text-2xl font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>{t('careers.departments.uiux.activities.experience.title')}</h3>
                  <p className={`leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                    {t('careers.departments.uiux.activities.experience.desc')}
                  </p>
                </div>
                
                <div className={`border-l-4 pl-6 ${isDark ? 'border-purple-500' : 'border-purple-400'}`}>
                  <h3 className={`text-2xl font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>{t('careers.departments.uiux.activities.systems.title')}</h3>
                  <p className={`leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                    {t('careers.departments.uiux.activities.systems.desc')}
                  </p>
                </div>
              </div>
            </motion.section>
            ...
            >
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  {
                    titleKey: 'careers.departments.uiux.roles.senior.title',
                    descKey: 'careers.departments.uiux.roles.senior.desc'
                  },
                  {
                    titleKey: 'careers.departments.uiux.roles.ui.title',
                    descKey: 'careers.departments.uiux.roles.ui.desc'
                  },
                  {
                    titleKey: 'careers.departments.uiux.roles.researcher.title',
                    descKey: 'careers.departments.uiux.roles.researcher.desc'
                  },
                  {
                    titleKey: 'careers.departments.uiux.roles.product.title',
                    descKey: 'careers.departments.uiux.roles.product.desc'
                  },
                  {
                    titleKey: 'careers.departments.uiux.roles.visual.title',
                    descKey: 'careers.departments.uiux.roles.visual.desc'
                  },
                  {
                    titleKey: 'careers.departments.uiux.roles.motion.title',
                    descKey: 'careers.departments.uiux.roles.motion.desc'
                  },
                  {
                    titleKey: 'careers.departments.uiux.roles.system.title',
                    descKey: 'careers.departments.uiux.roles.system.desc'
                  },
                  {
                    titleKey: 'careers.departments.uiux.roles.user.title',
                    descKey: 'careers.departments.uiux.roles.user.desc'
                  },
                  {
                    titleKey: 'careers.departments.uiux.roles.creative.title',
                    descKey: 'careers.departments.uiux.roles.creative.desc'
                  }
                ].map((role, index) => (
            ...
            >
              ...
              <div className="space-y-8">
                <div>
                  <h3 className={`text-2xl font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>{t('careers.departments.uiux.culture.remote.title')}</h3>
                  <p className={`leading-relaxed mb-4 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                    {t('careers.departments.uiux.culture.remote.p1')}
                  </p>
                  <p className={`leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                    {t('careers.departments.uiux.culture.remote.p2')}
                  </p>
                </div>
                
                <div>
                  <h3 className={`text-2xl font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>{t('careers.departments.uiux.culture.design.title')}</h3>
                  <p className={`leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                    {t('careers.departments.uiux.culture.design.desc')}
                  </p>
                </div>
                
                <div>
                  <h3 className={`text-2xl font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>{t('careers.departments.uiux.culture.collaboration.title')}</h3>
                  <p className={`leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                    {t('careers.departments.uiux.culture.collaboration.desc')}
                  </p>
                </div>
              </div>
            </motion.section>
            ...
            >
              ...
              <div className="space-y-8">
                <div>
                  <h3 className={`text-2xl font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>{t('careers.departments.uiux.career.learning.title')}</h3>
                  <p className={`leading-relaxed mb-4 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                    {t('careers.departments.uiux.career.learning.desc')}
                  </p>
                </div>
                
                <div>
                  <h3 className={`text-2xl font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>{t('careers.departments.uiux.career.paths.title')}</h3>
                  <p className={`leading-relaxed mb-4 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                    {t('careers.departments.uiux.career.paths.desc')}
                  </p>
                </div>
                
                <div>
                  <h3 className={`text-2xl font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>{t('careers.departments.uiux.career.onboarding.title')}</h3>
                  <p className={`leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                    {t('careers.departments.uiux.career.onboarding.desc')}
                  </p>
                </div>
              </div>
            </motion.section>
            ...
            >
              ...
              <div className="space-y-6">
                <div className={`border-l-4 pl-6 ${isDark ? 'border-purple-500' : 'border-purple-400'}`}>
                  <h3 className={`text-xl font-semibold mb-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>{t('careers.departments.uiux.expectations.excellence.title')}</h3>
                  <p className={isDark ? 'text-gray-300' : 'text-gray-700'}>{t('careers.departments.uiux.expectations.excellence.desc')}</p>
                </div>
                
                <div className={`border-l-4 pl-6 ${isDark ? 'border-purple-500' : 'border-purple-400'}`}>
                  <h3 className={`text-xl font-semibold mb-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>{t('careers.departments.uiux.expectations.thinking.title')}</h3>
                  <p className={isDark ? 'text-gray-300' : 'text-gray-700'}>{t('careers.departments.uiux.expectations.thinking.desc')}</p>
                </div>
                
                <div className={`border-l-4 pl-6 ${isDark ? 'border-purple-500' : 'border-purple-400'}`}>
                  <h3 className={`text-xl font-semibold mb-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>{t('careers.departments.uiux.expectations.technical.title')}</h3>
                  <p className={isDark ? 'text-gray-300' : 'text-gray-700'}>{t('careers.departments.uiux.expectations.technical.desc')}</p>
                </div>
                
                <div className={`border-l-4 pl-6 ${isDark ? 'border-purple-500' : 'border-purple-400'}`}>
                  <h3 className={`text-xl font-semibold mb-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>{t('careers.departments.uiux.expectations.collaboration.title')}</h3>
                  <p className={isDark ? 'text-gray-300' : 'text-gray-700'}>{t('careers.departments.uiux.expectations.collaboration.desc')}</p>
                </div>
                
                <div className={`border-l-4 pl-6 ${isDark ? 'border-purple-500' : 'border-purple-400'}`}>
                  <h3 className={`text-xl font-semibold mb-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>{t('careers.departments.uiux.expectations.learning.title')}</h3>
                  <p className={isDark ? 'text-gray-300' : 'text-gray-700'}>{t('careers.departments.uiux.expectations.learning.desc')}</p>
                </div>
              </div>
            </motion.section>
            ...
            >
              <div className={`bg-gradient-to-r backdrop-blur-sm border rounded-2xl p-12 ${isDark ? 'from-purple-600/20 to-indigo-600/20 border-purple-500/30' : 'from-purple-600/10 to-pink-600/10 border-purple-500/20 bg-white/30'}`}>
                <h3 className={`text-3xl md:text-4xl font-bold mb-6 ${isDark ? 'text-white' : 'text-gray-900'}`}>{t('careers.departments.uiux.cta.title')}</h3>
                <p className={`text-xl mb-10 max-w-3xl mx-auto ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                  {t('careers.departments.uiux.cta.desc')}
                </p>
