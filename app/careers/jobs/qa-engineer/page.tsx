    ...
    <div className={`min-h-screen transition-colors duration-300 ${isDark ? 'bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900' : 'bg-gradient-to-br from-purple-50 via-pink-50 to-purple-100'}`}>
      ...
      <div className="fixed top-20 left-4 z-50">
        <Link href="/careers/apply">
          <button className={`flex items-center gap-2 transition-colors duration-300 ${isDark ? 'text-white hover:text-purple-300' : 'text-gray-900 hover:text-purple-600'}`}>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className={isDark ? 'text-gray-300' : 'text-gray-700'}>Demonstrate your testing skills through our technical challenges designed to evaluate your problem-solving abilities and QA expertise.</p>
                </div>
              </div>
          ...
          >
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-4">
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Design and execute comprehensive test plans for web and mobile applications</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Perform manual and automated testing to identify bugs and quality issues</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Collaborate with development teams to ensure quality standards throughout the development lifecycle</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Document test cases, test results, and quality metrics</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Participate in code reviews and provide feedback on testability</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Contribute to the improvement of testing processes and methodologies</li>
              </ul>
            </div>
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-4">
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Experience with manual testing methodologies and best practices</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Knowledge of automated testing tools (Selenium, Cypress, or similar)</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Understanding of web technologies (HTML, CSS, JavaScript)</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Experience with bug tracking and project management tools</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Strong analytical and problem-solving skills</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Excellent communication and documentation skills</li>
              </ul>
            </div>
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-4">
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Experience with API testing and tools like Postman or similar</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Knowledge of performance testing tools and methodologies</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Understanding of CI/CD pipelines and DevOps practices</li>
                <li className={isDark ? 'text-gray-300' : 'text-gray-700'}>Experience with mobile app testing (iOS/Android)</li>
              </ul>
            </div>
          </motion.div>
        </div>
