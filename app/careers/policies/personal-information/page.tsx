        ...
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-3">Assessment Data</h3>
                <ul className="text-gray-300 space-y-2 ml-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-3">Communication Records</h3>
                <ul className="text-gray-300 space-y-2 ml-4">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-3">Legal & Administrative</h3>
                <ul className="text-gray-300 space-y-2 ml-4">
          ...
          >
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold text-white mb-3">Security Safeguards</h3>
                <p className="text-gray-300 leading-relaxed">
