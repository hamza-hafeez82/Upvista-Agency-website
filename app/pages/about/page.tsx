        ...
        <section className="container mx-auto px-4 py-12 max-w-3xl flex flex-col md:flex-row items-center gap-8">
          ...
          >
            ...
            <div className="mt-4 flex justify-center md:justify-start gap-4">
              <a href="https://www.linkedin.com/groups/13302224" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg font-medium shadow hover:scale-105 transition-transform">
                Connect with Hamza
