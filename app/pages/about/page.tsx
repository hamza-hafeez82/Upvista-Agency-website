...
export default function AboutUs() {
  ...
  return (
    <>
      <Head>
        <title>About Upvista Digital | Visionaries, Builders, Partners</title>
        <meta name="description" content="Upvista Digital is a collective of dreamers, doers, and digital architects. Our mission: to inspire, empower, and transform through technology and human connection." />
        <meta name="keywords" content="Upvista, Upvista Digital, upvista, upvista digital, About Upvista, Digital Agency, Community, Partnerships, Innovation, Empowerment, Collaboration, Research, Pakistan, Global" />
        <meta property="og:title" content="About Upvista Digital | Visionaries, Builders, Partners" />
        <meta property="og:description" content="Upvista Digital is a collective of dreamers, doers, and digital architects. Our mission: to inspire, empower, and transform through technology and human connection." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://upvistadigital.com/pages/about" />
        <meta property="og:image" content="https://upvistadigital.com/assets/heroimg.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="About Upvista Digital | Visionaries, Builders, Partners" />
        <meta name="twitter:description" content="Upvista Digital is a collective of dreamers, doers, and digital architects. Our mission: to inspire, empower, and transform through technology and human connection." />
        <meta name="twitter:image" content="https://upvistadigital.com/assets/heroimg.png" />
        <link rel="canonical" href="https://upvistadigital.com/pages/about" />
        {/* Organization Structured Data */}
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          '@context': 'https://schema.org',
          '@type': 'Organization',
          name: 'Upvista Digital',
          url: 'https://upvistadigital.com/pages/about',
