    ...
    <div className="min-h-screen bg-black text-white flex">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-6 md:p-8 overflow-y-auto pb-20 md:pb-8">
          ...
          <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-emerald-500/20 via-teal-500/20 to-cyan-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '4s' }}></div>
          <div className="absolute top-20 left-20 w-64 h-64 bg-gradient-to-br from-green-500/20 via-emerald-500/20 to-teal-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '5s' }}></div>
