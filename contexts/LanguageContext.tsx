...
const translations: Record<string, Record<string, string>> = {
  ...
  AR: {
    ...
    'nav.researches': 'البحوث',
    'nav.insights': 'الرؤى',
    'nav.careers': 'استكشف الوظائف',
    'nav.contact': 'دعنا نتحدث عن الأعمال',
    'hero.title': 'الحلول الرقمية التي تدفع النمو',
    'hero.subtitle': 'حول عملك باستخدام أحدث التقنيات والحلول المبتكرة.',
    'hero.cta': 'ابدأ',
    'hero.register': 'سجل',
    'hero.badge': 'Upvista Digital - وكالة البرمجيات الرائدة في باكستان',
    'hero.service1': 'تطوير الويب',
    'hero.service2': 'هندسة البرمجيات',
    'hero.service3': 'الرسوم والتصميم',
    'hero.service4': 'أتمتة الذكاء الاصطناعي',
    'hero.stats1': 'المشاريع المسلمة',
    'hero.stats2': 'تقييم العميل',
    'hero.stats3': 'الدعم',
    // Development Roadmap
  ...
  ES: {
    ...
    'hero.cta': 'Comenzar',
    'hero.register': 'Registrarse',
    'hero.badge': 'Upvista Digital - Agencia de Software Principal de Pakistán',
    'hero.service1': 'Desarrollo Web',
    'hero.service2': 'Ingeniería de Software',
    'hero.service3': 'Gráficos y Diseño',
    'hero.service4': 'Automatización IA',
  ...
  ES: {
    'about.hero.title': 'Upvista Digital',
    'about.hero.tagline': 'Donde los Visionarios Construyen el Futuro',
    'about.hero.description': 'No somos solo una empresa de software, somos un movimiento. Inspiramos, empoderamos y elevamos marcas a un estatus legendario a través de la innovación, investigación y conexión humana.',
    'about.hero.cta.primary': 'Inicia Tu Viaje',
    'about.hero.cta.secondary': 'Conoce Nuestro Equipo',

    'about.founder.title': 'Conoce al Fundador',
    'about.founder.name': 'Hamza Hafeez',
    'about.founder.quote': 'En Upvista, no solo entregamos proyectos, creamos movimientos. Nuestra misión es inspirar, innovar y establecer nuevos estándares de grandeza digital. Únete a nosotros y construyamos un legado juntos.',
    'about.founder.connect': 'Conectar con Hamza',

    'about.journey.title': 'El Viaje de Upvista',
    'about.journey.vision.title': 'La Visión',
    'about.journey.vision.desc': 'Upvista nació de un deseo de romper límites y redefinir lo que puede ser una agencia digital—donde la creatividad, la tecnología y la comunidad convergen para crear experiencias digitales extraordinarias.',
    'about.journey.movement.title': 'Construyendo el Movimiento',
    'about.journey.movement.desc': 'Desde nuestro primer proyecto hasta nuestra creciente comunidad, cada paso ha sido sobre empoderar a otros y crear un efecto dominó de cambio positivo en el mundo digital a través de la colaboración e innovación.',
    'about.journey.mindset.title': 'Una Marca, Una Mentalidad',
    'about.journey.mindset.desc': 'Hoy, Upvista es más que una empresa—es una mentalidad. Somos un símbolo de confianza, innovación y potencial ilimitado para clientes y colaboradores en todo el mundo, inspirando la excelencia digital.',

    'about.mission.title': 'Nuestra Misión y Visión',
    'about.mission.vision': 'Visión',
    'about.mission.visionDesc': 'Ser la fuerza líder en transformación digital, empoderando a visionarios y organizaciones para lograr un éxito digital extraordinario a través de tecnología innovadora y diseño centrado en humanos.',
    'about.mission.mission': 'Misión',
    'about.mission.missionDesc': 'Inspirar, empoderar y elevar marcas a través de tecnología de vanguardia, soluciones basadas en investigación y conexiones humanas significativas que crean impacto duradero e impulsan cambios positivos.',

    'about.pillars.title': 'Nuestros Cuatro Pilares',
    'about.pillars.agency.title': 'Agencia',
    'about.pillars.agency.desc': 'Entregamos transformación digital premium de extremo a extremo—web, móvil, IA, branding y más allá. Nuestro trabajo no es solo servicio; es una firma de excelencia e innovación.',
    'about.pillars.community.title': 'Comunidad',
    'about.pillars.community.desc': 'Un colectivo próspero de desarrolladores, diseñadores y pensadores visionarios. Aquí, la colaboración impulsa el crecimiento, los proyectos de código abierto florecen y cada miembro está empoderado para liderar e innovar.',
    'about.pillars.partnerships.title': 'Asociaciones',
    'about.pillars.partnerships.desc': 'Creemos en crecer juntos. A través de alianzas estratégicas, combinamos fortalezas, compartimos oportunidades y creamos impacto que trasciende fronteras e impulsa el éxito mutuo.',
    'about.pillars.research.title': 'Investigación',
    'about.pillars.research.desc': 'Realizamos investigaciones de vanguardia en IA, desarrollo web y transformación digital. Nuestro enfoque basado en evidencia asegura soluciones innovadoras respaldadas por rigor científico y aplicación práctica.',
    ...
    'about.testimonials.title': 'Lo que Dicen Nuestros Socios',

    'about.cta.title': '¿Listo para Transformar Tu Presencia Digital?',
    'about.cta.subtitle': 'Únete a cientos de visionarios que han elegido Upvista Digital para hacer realidad sus sueños digitales. Creemos algo extraordinario juntos.',
    'about.cta.primary': 'Inicia Tu Proyecto',
    'about.cta.secondary': 'Ponte en Contacto',
